...
namespace Nop.Web.Areas.Admin.Factories
{
    ...
    public partial class SettingModelFactory : ISettingModelFactory
    {
        ...
        protected virtual StoreInformationSettingsModel PrepareStoreInformationSettingsModel()
        {
            ...
            model.SitemapIncludeProductTags_OverrideForStore = _settingService.SettingExists(sitemapSettings, x => x.SitemapIncludeBlogPosts, storeId);
            model.SitemapIncludeProductTags_OverrideForStore = _settingService.SettingExists(sitemapSettings, x => x.SitemapIncludeNews, storeId);
            model.SitemapIncludeProductTags_OverrideForStore = _settingService.SettingExists(sitemapSettings, x => x.SitemapIncludeTopics, storeId);
